...
public class Card
{
	...
	public Card(int number, String suit)
	{
		...
		//The parameter number is a local varable and only exists in this method
		//The keyword this means it is the INSTANCE, not the LOCAL variable
		this.number = number;  //set the instance variable
		this.suit = suit;
	...
	{
		return number;  //this.number not needed, since no local variable of same name
	}
